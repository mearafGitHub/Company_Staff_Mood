...
public class GebeyaIntro extends BaseActivity {
   ...
   private int position;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        screens.add(new IntroScreenItem("Gebeaya Mood", "By Gebeya Inc. We care about how you feel about everything in Gebeya. Enjoy sharing your mood while working with your colleagues at Gebeya Inc. ", R.drawable.gebeya1));
        ...
        screens.add(new IntroScreenItem("Show you colleagues mood.", "In the common screen you can see your colleagues teams mood.", R.drawable.gebeya2));
        screens.add(new IntroScreenItem("Sign Up to use", "Sign up to meet Chad. Please note that your moods will be reviewed by a person in charge to see closely what to improve about Gebeya to make you comfortable at Gebeya.", R.drawable.gebeya1));
